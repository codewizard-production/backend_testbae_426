...
@Entity(name = "IncentiveSEExec")
@Table(name = "\"IncentiveSEExec\"", schema =  "\"testbae\"")
@Data
                        
public class IncentiveSEExec {
	public IncentiveSEExec () {   
  }
	  
  @Id
  @GeneratedValue(strategy = GenerationType.IDENTITY)
  @Column(name = "\"IncentiveSEId\"", nullable = true )
  private Integer incentiveSEId;
  ...
  public String toString() {
	return "IncentiveSEExec [" 
  + "IncentiveSEId= " + incentiveSEId  + ", " 
  + "Amount= " + amount  + ", " 
  + "Date= " + date 
 + "]";
	}
